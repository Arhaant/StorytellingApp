			...
			<View style={styles.container}>
				...
				<View style={styles.fieldsContainer}>
					<ScrollView>
                        ...
                        <TextInput style={styles.callItWhatever} onChangeText={moral => this.setState({ moral })} placeholder="Item" placeholderTextColor={'white'} multiline={true} numberOfLines={3}></TextInput>
					</ScrollView>
